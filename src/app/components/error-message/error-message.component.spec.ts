...
describe('ErrorMessageComponent', () => {
  ...
  it('should show an error message on field touched and error present', () =>{
  ...
  it('should hide error message on field touched and has an error, but it is a different error', () =>{
    component.field = new FormGroup({anyField: new FormControl()})
